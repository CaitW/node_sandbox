...
const METADATA_INVENTORY = {
    ...
    // Permissions
    permissions_section: METADATA.permissions_section,
    allow_visualization: METADATA.allow_visualization,
    mol_modeling: METADATA.mol_modeling,
    allow_download: METADATA.allow_download,
    // Release Policy
    set_release_date: METADATA.set_release_date,
    no_release_date: METADATA.no_release_date,
    ...
    // Citation
    citation_formatted: METADATA.citation_formatted,
    ...
    specific_taxon_groups: METADATA.specific_taxon_groups,
    //  Geographic Coverage
    ...
    // Quality
    quality_control: METADATA.quality_control
}
...
const METADATA_OCCURRENCE = {
    ...
    allow_download: METADATA.allow_download,
    // Release Policy
    set_release_date: METADATA.release_date,
    no_release_date: METADATA.no_release_date,
    release_date: METADATA.release_date,
    // License
    license: METADATA.license,
